    ...
    <div class="container my-5">
        ...
        <form action="agent_bid_process.php" method="post">
            <div class="form-element my-4">
                <input type="text" class="form-control" name="bid_id" placeholder="Bid ID:">
            </div>
            ...
            <div class="form-element my-4">
                <input type="text" class="form-control" name="min_bid_price" placeholder="Minimum Bid Price:">
            </div>
            ...
            <div class="form-element my-4">
                <input type="date" class="form-control" name="bid_end_date" placeholder="Bid End Date:">
            </div>
