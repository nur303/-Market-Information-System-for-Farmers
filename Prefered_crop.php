            ...
            <aside class="sidebar">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="shop_number.php">shop_number</a></li>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column text-start footer-item">
                        <h4 class="text-light mb-3">shopeco Info</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column text-start footer-item">
                        ...
                        <a class="btn-link" href="">shopeco details</a>
                        <a class="btn-link" href="">shopecoping Cart</a>
