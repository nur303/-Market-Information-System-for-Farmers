...
if (isset($_POST["create_sale"])) {
    ...
    $harvest_date = mysqli_real_escape_string($connection, $_POST["harvest_date"]);
    $date_sold = mysqli_real_escape_string($connection, $_POST["date_sold"]);
    $quantity = mysqli_real_escape_string($connection, $_POST["quantity"]);
    $sold_price = mysqli_real_escape_string($connection, $_POST["sold_price"]);
    $production_expense = mysqli_real_escape_string($connection, $_POST["production_expense"]);
    $farmer_profit = mysqli_real_escape_string($connection, $_POST["farmer_profit"]);
