...
<body>
            ...
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    ...
                    <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                            class="text-white">ecochainharbor@mail.com</a></small>
                </div>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index.php" class="navbar-brand">
                    <h1 class="text-primary display-6">EcoChainHarbor</h1>
                </a>
    ...
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6">By Fresh Items</h1>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <p class="mb-4">EcoChainHarbor is preferred for its commitment to fresh, sustainably sourced
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <p>Email: ecochainharbor@mail.com</p>
